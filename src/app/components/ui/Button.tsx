import { classname } from "@/app/lib/utils";
import { cva, VariantProps } from "class-variance-authority";
import { Loader2 } from "lucide-react";
import * as React from "react";

const buttonVariants = cva(
  "active:scale-95 inline-flex items-center justify-center rounded-md text-sm font-medium transition-colors  focus:bg-slate-100 disabled:opacity-50 disabled:pointer-events-none ",
  {
    variants: {
      variant: {
        ...
        ghost: "bg-transparent hover: text-bold",
