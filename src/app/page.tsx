      ...
      <div className='flex flex-col items-center lg:flex-row pt-32 max-w-7xl w-full mx-auto h-full'>
        <div className=' px-3 h-full gap-3 flex flex-col justify-start items-center lg:items-start'>
            ...
            <Paragraph className='max-w-xl text-left'>
              ...
              best way is <Link href="https://twitter.com/krishi_sa" className='underline'>Twitter</Link>.
            </Paragraph>
            <Paragraph className='max-w-xl text-left'>
              I grew up in many different places, but I call California my home. I spend vast amounts of my time
